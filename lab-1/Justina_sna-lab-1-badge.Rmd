...
author: "Justina Rodriguez Jackson"
...
2.  Who are the network's actors and how are they represented visually?
    ...
    -   The network actors were 50 students enrolled in a course. They were represented by individual nodes, sized by degree, using whole network analysis.

3.  What ties connect these actors and how are they represented visually?

    -   The ties between actors represent collaboration in a course using dichotomized data

4.  Why were these relations of interest to the researcher?

    -   There were two surveys that took place to measure the changes in the collaboration over the course of the semester as the student completed a capstone project.

5.  Finally, what makes this collection of actors a social network?

    -   They are bound by their participation in a farm management and operations course.
...
In a newly admitted cohort of PhD students within a specific degree program, who are the most influential individuals for sharing/receiving/communicating information?

1.  What relational data would need to be collected?

    -   identifying "who works with who" and how is the relationship defined, frequency of communication, type of communication, purpose of communication.

2.  For what reason would relational data need to be collected in order to address this question?

    -   In order to understand who the most influential individuals are within a group, we might also be able to identify characteristics of influencers within a cohort who could inform a peer mentoring group.

3.  Explain the analytic level at which these data would need to be collected and analyzed.

    -   The data would need to be collected at the individual level and analyzed at the individual level using a survey with a roster of the students in the cohort. It will be non-directional and attempt to do whole-network method, because I have defined the total population of PhD student roster within a specific degree program.
...
4.  How does this differ from the ways in which individual or group behavior is typically conceptualized and modeled in conventional educational research?
    ...
    -   It will be able to visually represent the relationships between members of the cohort. conventional education research might be able to measure belonging or participation, but would lack information about the nature of the relationships between many individuals.
...
dlt2_edges <- read_csv("data/dlt2-edges.csv")
